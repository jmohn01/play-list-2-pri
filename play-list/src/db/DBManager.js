export default class DBManager {
    ...
    queryGetList = (key) => {
        ...
        console.log("list", JSON.parse(listString))
    ...
    mutationCreateSong = (Songs) => {
        this.mutationUpdateSong(Songs);
    }
    mutationUpdateSong = (songs) => {
        // AND FLOW THOSE CHANGES TO LOCAL STORAGE
        let listString = JSON.stringify(songs);
        localStorage.setItem("playlister-song-" + songs.key, listString);
    }
